...
- Lake was drained, statues moved, wildlife displaced. 800 citizens protested at the Royal Palms Hotel. Superior Court initially sided with residents, but CA Supreme Court overturned in 1934.
- Transformed from a "destination park" to a "drive-through park" (Jose A. Gardea, author of MacArthur Park Images of America).
...
From convo 2:
- LA began with dense, walkable cores — Westlake, Bunker Hill, Broadway, Boyle Heights — then through zoning, freeways, and the cult of the automobile, trained all its energy outward.
- Each new subdivision siphoned wealth and attention from the core. "The city's lifeblood drained into cul-de-sacs and freeways, until LA became less a city than an archipelago of parking lots."
- "Sprawl was not just a planning error; it was a moral one. It trained us to prefer separation over solidarity."
- Suburbs are a Ponzi scheme — each new cul-de-sac requires more infrastructure than its property taxes can support (Chuck Marohn / Strong Towns).
- Notable Westlake-era buildings worth mentioning: the Bryson, the Arcady, the Sheraton Town House.
- Fragments of the old grandeur that survive: Million Dollar Theater, Fine Arts Building, the MacArthur, the Bradbury Building.
- Contrast with Paris: "Paris preserved its civic grandeur. Los Angeles dismantled it — often quite literally, bulldozing it for parking lots and office towers."
...
- The city that once invited promenades became a place to flee from in air-conditioned solitude.
- The public realm was traded for private convenience; shared soul of the city disappeared.
- Can return to the MacArthur Park image — empty benches, no families — as microcosm of that alienation.
- The 1942 renaming from Westlake to MacArthur Park (pushed by Hearst for political reasons) is a symbolic death — civic memory overwritten by nationalism. Letters poured into the LA Times defending the old name. One resident wrote: "parks go on forever."

From convo 2 — Marx's alienation mapped to car dependency (4 forms of estrangement):
- Estrangement from your own body (as the car drives for you)
- Estrangement from community (as every public square becomes a parking lot)
- Estrangement from nature (as the landscape is flattened for freeways)
- Estrangement from your own potential (as your time is devoured by commutes)
- "The built environment is ideology made visible. Capitalist cities spatialize the economy's logic: private over public, profit over beauty, speed over connection."
...
- Westlake Weekly, c. 1910 — "the most popular open-air resort in the city"
- LA Times 1914 — Miller's Military Band, lantern-lit canoes description
